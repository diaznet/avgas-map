...
2. WHEN the front-end needs aerodrome data THEN the system SHALL load the cycle manifest shipped with the site and fetch the selected cycle's dataset from its GitHub Release asset (no backend server required).
